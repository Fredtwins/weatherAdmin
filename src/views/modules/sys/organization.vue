<template>
  <div class="mod-config">
    <el-form :inline="true" :model="dataForm" @keyup.enter.native="submitSearch()">
      <el-form-item>
        <el-input v-model="dataForm.key" placeholder="请输入" clearable></el-input>
      </el-form-item>
      <el-form-item>
        ...
        <el-button v-if="isAuth('sys:organization:delete')" type="danger" @click="deleteHandle()" :disabled="dataListSelections.length <= 0">批量删除</el-button>
      </el-form-item>
    </el-form>
    <el-table
      :data="dataList"
      ...
      <el-table-column
        ...
        <template slot-scope="scope">
          <img :src="scope.row.logo" alt="" style="width: 100px;height:35px">
        </template>
      </el-table-column>
      <el-table-column
        prop="description"
